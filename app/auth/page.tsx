...
export const metadata: Metadata = {
  ...
  description:
    "Entre a la maravillo plataforma que te ayudara a mantener tu salud financiera y a llegar a fin de mes sin preocupaciones",
};
      ...
      <div className="flex flex-col justify-center items-center gap-6 p-10 w-full h-full">
        ...
        <div className="flex flex-col gap-6">
          <form
            action={async () => {
              "use server";
              await signIn("google", { redirectTo: "/first-steps" });
            }}
          >
          ...
          <form
            action={async () => {
              "use server";
              await signIn("github", { redirectTo: "/first-steps" });
            }}
          >
          ...
          <form
            action={async () => {
              "use server";
              await signIn("linkedin", { redirectTo: "/first-steps" });
            }}
          >
